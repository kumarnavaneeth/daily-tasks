 ...
 */
@Generated
public class TicketServiceApplication__ApplicationContextInitializer implements ApplicationContextInitializer<GenericApplicationContext> {
  @Override
  public void initialize(GenericApplicationContext applicationContext) {
    ...
    new TicketServiceApplication__BeanFactoryRegistrations().registerBeanDefinitions(beanFactory);
    new TicketServiceApplication__BeanFactoryRegistrations().registerAliases(beanFactory);
  }
